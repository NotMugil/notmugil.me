             ...
             <div class="flex flex-row items-center gap-2">
                <div class="bg-dark bg-opacity-90 backdrop-blur px-4 py-2 flex items-center flex-row gap-2 rounded-full cursor-pointer">
                   <span class="text-white">
                      <svg viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" width="15" height="15"><path d="M11 1.5h2.5v12a1 1 0 01-1 1h-10a1 1 0 01-1-1v-12H4M7.5 6v5M5 8.5h5M4.5.5h6v2a1 1 0 01-1 1h-4a1 1 0 01-1-1v-2z" stroke="currentColor"></path></svg>
                   </span>
