<div class="mt-8 md:mt-24 mx-4 md:mx-8 lg:mx-0 font-satoshi">
	<h1 class="text-md md:text-md lg:text-lg font-bold">About Me</h1>
	...
	<!-- <p class="text-small lg:text-p font-medium py-4">
		...
		with the latest technologies. When I am not immersed in coding, I enjoy indulging in reading
		books, playing games, and experimenting with new foods and recipes. Please feel free to reach
		out to me through any of my social media channels if you have any questions or simply want to
