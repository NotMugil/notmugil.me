<div class="max-w-screen-lg w-full sticky top-4 z-50 m-4 mx-auto justify-center fixed relative flex overflow-x-hidden">
    <div class="backdrop-blur-lg bg-dark bg-opacity-80 px-8 mx-4 flex flex-col lg:flex-row rounded-lg w-full">
        <div class="w-full flex flex-row justify-between items-center my-2">
            <div class="p-2">
                <a href="/" class="">
                    <span class="text-accent font-primary font-semibold">not</span><span class="text-primary font-primary font-semibold">mugil</span>
                </a>
            </div>
            <div>
                <button class="toggle p-2 text-primary lg:invisible">
        ...
        <div class="text-secondary pl-2 lg:flex lg:align-center">
            <ul class="nav-li hidden lg:flex lg:flex-nowrap lg:gap-4 mb-4 lg:mb- lg:my-auto lg:align-center mx-1 font-primary font-regular transition-all duration-300"> 
                ...
                <li class="p-1 hover:text-accent "><a href="/" class="">projects</a></li>
                <li class="p-1 hover:text-accent "><a href="/" class="">blog</a></li>
                ...
                <span class="hover:text-accent hidden lg:flex lg:align-center lg:my-auto">
                    <li class="p-2">
                     <a href="https://github.com/NotMugil" target="_blank" class="">
...
<script>
    ...
    onMount(() => {
        ...
        console.log(navList); // Check if navList is correctly selected
        console.log(toggler); // Check if toggler is correctly selected
